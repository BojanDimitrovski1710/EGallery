...
namespace EGallery.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<EGalleryApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
